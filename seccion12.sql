...
#creando una vista 
create view vista_empleado as select
concat(apellido, ' ', e.nombre) as nombre, sexo, s.nombre as seccion, cantidadhijos from empleados as e 
join secciones as s
on codigo = seccion;
...
#vista basada en otra vista

create view view_empleado_con_hijos as select nombre, sexo, seccion, cantidadhijos
from vista_empleado where cantidadhijos > 0;

select * from view_empleado_con_hijos;

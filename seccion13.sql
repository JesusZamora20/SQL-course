...
delimiter //
create procedure pa_librosstock()
begin
...
delimiter //
create procedure pa_librosautor(
...
drop procedure if exists pa_librosautor;

call pa_librosautor('Richard Bach', 'Planeta');

# parametros de salida

delimiter //
create procedure pa_autortotalpromedio (
	in p_autor varchar(50),
...
call pa_autortotalpromedio('Richard Bach',@s, @p);
